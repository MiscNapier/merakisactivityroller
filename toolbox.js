...
// merakis activity roller only
// familiar dropdown visibility toggle
function familiarCheck() {
  let rune = document.getElementById("rune").checked,
      master = document.getElementById("master").checked,
      f2 = document.getElementById("famcon2"),
      f3 = document.getElementById("famcon3");
      f2s = document.getElementById("familiar2");
      f3s = document.getElementById("familiar3");
  if (rune === true) {
